(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Tinode = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  const Connection = function(config, version_, autoreconnect_) {
    ...
    function init_lp(instance) {
      ...
      function lp_sender(url_) {
        ...
        sender.setRequestHeader('Authorization', `Bearer ${localStorage.getItem("access_token")}`);
        sender.setRequestHeader('id_device', `${localStorage.getItem("id_device")}`);
        return sender;
      }
      ...
      function lp_poller(url_, resolve, reject) {
        ...
        poller.setRequestHeader('Authorization', `Bearer ${localStorage.getItem("access_token")}`);
        poller.setRequestHeader('id_device', `${localStorage.getItem("id_device")}`);
        return poller;
      }
  ...
  LargeFileHelper.prototype = {
    ...
    uploadWithBaseUrl: function(baseUrl, data, avatarFor, onProgress, onSuccess, onFailure) {
      ...
      this.xhr.setRequestHeader('Authorization', `Bearer ${localStorage.getItem("access_token")}`);
      this.xhr.setRequestHeader('id_device', `${localStorage.getItem("id_device")}`);
