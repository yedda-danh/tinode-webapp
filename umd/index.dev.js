...
class LoginView extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    }, token_prompt => react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
      type: "text",
      id: "inputToken",
    ...
    }, id_device_prompt => react__WEBPACK_IMPORTED_MODULE_0___default().createElement("input", {
      type: "text",
      id: "inputIdDevice",
...
class TinodeWeb extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  handleConnected() {
    ...
    if (this.state.autoLogin) {
      this.doLogin(this.state.login, this.state.password, this.state.token, this.state.id_device, {
        meth: this.state.credMethod,
        resp: this.state.credCode
      });
    }
