...
export default class LoginView extends React.Component {
  ...
  componentDidMount() {
    console.log("token in componentDidMount: ", this.state.token);
    console.log("id_device in componentDidMount: ", this.state.id_device);

    if (this.state.token) {
      localStorage.setItem("access_token", this.state.token.trim());
    }

    if (this.state.id_device) {
      localStorage.setItem("id_device", this.state.id_device.trim());
    }
  }
